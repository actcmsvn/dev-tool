...
class TableMakeCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    ...
    public function handle(): int
    {
        ...
        $path = platform_path(
            Helper::joinPaths([$this->promptModule(), 'src', 'Tables', ucfirst(Str::studly($name)) . 'Table.php'])
        );
