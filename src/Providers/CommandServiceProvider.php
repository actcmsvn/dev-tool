...
use ACTCMS\PluginManagement\Providers\PluginManagementServiceProvider;
use ACTCMS\Theme\Providers\ThemeServiceProvider;
use ACTCMS\Widget\Providers\WidgetServiceProvider;
...
class CommandServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        if (version_compare(get_core_version(), '1.0.0', '>=')) {
            $this->commands([
